...
module door_hole(x) {
    translate([x*25/2-(29+28)/2,-1,-1]) cube([29+28,9.7-1.5,40]);
    translate([x*25/2-(31+28)/2,5,-1]) cube([31+28,12.2,40]);
    translate([x*25/2-(33+28)/2,-1,38.8-3.1]) cube([33+28,12.2,3.2]);
}

module stucco_hole(x) {
    translate([(x*25)/2-(29+28)/2,-1,-1]) cube([29+28,12.2,40]);
    translate([(x*25)/2-(33+28)/2,-1,38.8-3.1]) cube([33+28,12.2,3.2]);
}
...
module door_top_1() {
    color("SaddleBrown") {
        difference() {
            union() {
                translate([(75)/2-(32.8+28)/2,0,38.8-3.1]) cube([32.8+28,10.2,3.2]);
                translate([75/2-(24.8+28)/2,10.2-3,38.8-7]) cube([24.8+28,2,5]);
            }
            hull() {
                translate([75/2,0,38.8-3]) rotate([0,45+90,0]) cube([1,10.2,1]);
                translate([12.1,0,38.8-7]) rotate([-90,0,0]) cylinder(10,1,1,$fn=50);
                translate([75-12.1,0,38.8-7]) rotate([-90,0,0]) cylinder(10,1,1,$fn=50);
            }
...
module door_top_2() {
    color("SaddleBrown") {
        difference() {
            union() {
                translate([(75)/2-(32.8+28)/2,0,38.8-3.1]) cube([32.8+28,10.2,3.2]);
                translate([75/2-(24.8+28)/2,10.2-3,38.8-7]) cube([24.8+28,2,4]);
            }
            translate([75/2,0,38.8-7]) rotate([-90,0,0]) scale([1,.15,1]) cylinder(10,26,26,$fn=50);
            translate([10.5+3.5,3.7,1]) cylinder(50,1,1,$fn=25);
        }
    }
}
...
module door_top_3() {
    color("SaddleBrown") {
        difference() {
            union() {
                translate([(75)/2-(32.8+28)/2,0,38.8-3.1]) cube([32.8+28,10.2,3.2]);
                translate([75/2-(24.8+28)/2,10.2-3,38.8-6]) cube([24.8+28,2,3]);
            }
            //translate([10.5+3.5,3.7,1]) cylinder(50,1,1,$fn=25);
        }
    }
...
/* Base
difference() {
    translate([0.1,0.1,0]) cube([x*25-.2,10,5.2]);
    translate([x*25/2-(29+28)/2,-1,-1]) cube([29+28,8.2,40]);
    translate([x*25/2-(25+28)/2,-1,-1]) cube([25+28,12.2,40]);
}
*/
            ...
            union() {
                color("SaddleBrown") difference() {
                    ...
                    union() {
                        hull() {
                            difference() {
                                translate([10,2,-3]) rotate([0,0,45]) cube([1,1,6]);
                                translate([10,2,-3]) cube([2,2,6]);
                            }
                            translate([-11.5+2.5,4.2+2,-5]) cylinder(10,1,1,$fn=50);
                            translate([11.5-2.5,4.2+2,-5]) cube([1,1,6]);
                        }
